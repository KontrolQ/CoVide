    ...
    */
    ...
    for (let i = 1; i < this.stateData.length; i++) {
      ...
      <div class="slide" style="width:90%;">
        <ion-card class="cardToClickForStateData" id="${this.stateData[i].state}" style="padding: 0px 0px; 10px 0px">
          <img src="${imageSource}" style="height: 230px;
          width: 100%;
          pointer-events: none;" />
          <ion-card-header>
            <ion-card-subtitle style='color: red;'>+${this.stateData[i].deltaconfirmed} Today</ion-card-subtitle>
